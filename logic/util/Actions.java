...
public class Actions {
	...
	if (a.isNot(S.USED) && (a != b)) {
		...
		n.set(F.DAMAGE, n.v(F.DAMAGE) * (1f - (0.35f * ((b.incoming + b.units - b.outgoing) / Constants.MAX_UNITS))));
	
	    for (Site n : a.neighbors.values())
		n.set(F.REINFORCE, n.v(F.REINFORCE) * (1f - (0.0125f * ((b.incoming + b.units - b.outgoing) / Constants.MAX_UNITS))));
